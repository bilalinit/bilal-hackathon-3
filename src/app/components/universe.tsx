...
const Universe = () => {
  return (
    <div className=" sm:h-[682px] pt-[120px] sm:pt-0 px-[9.83px] sm:px-0 overflow-hidden ">
          ...
          <div className="bg-[url('/hero-cover-3.png')] w-[100%] h-[682px] bg-cover bg-center sm:block hidden "></div>
            <div id="text content" className=" flex flex-col gap-[30px] sm:pr-[198px]">
                ...
                <div className="flex sm:flex-row flex-col gap-[25px] sm:gap-[10px] sm:mx-0 mx-[114.67px]">
                    <button className="font-montserrat font-bold text-[14px] leading-[22px] tracking-[0.2px] py-[15px] px-[40px] rounded-[5px] bg-[#23A6F0] sm:bg-[#2DC071] text-white transform transition-transform duration-1000 hover:scale-110 hover:translate-2   ">BUY NOW</button>
                    <button className="font-montserrat font-bold text-[14px] leading-[22px] tracking-[0.2px] py-[15px] px-[40px] rounded-[5px] border border-[#23A6F0] text-[#23A6F0] sm:border-[#2DC071] sm:text-[#2DC071] text-nowrap transform transition-transform duration-1000 hover:scale-110 hover:translate-2  ">READ MORE</button>
                </div>
            </div>
